...
app.post("/api/v1/score", (req, res) => {
    const newScore = new Score({
        ...
        commentry:req.body.commentry,
        batsmanNameA:req.body.batsmanNameA,
        batsmanNameB:req.body.batsmanNameB,
        bowlerNameA:req.body.bowlerNameA,
        bowlerNameB:req.body.bowlerNameB,
        runsA: req.body.runsA,
        runsB:req.body.runsB,
        ballsA: req.body.ballsA,
        ballsB:req.body.ballsB,
    });
    newScore.save().then(() => {
